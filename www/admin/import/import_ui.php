...
function import_columns_help_html(array $flow): string {
    ...
    $columns = [
        ...
        ['sentences', 'optional', 'example sentence(s) using the word. Several sentences go in one cell separated by | (a pipe) — all of them show on the flashcard. A JSON array works too, but the cell must then be quoted. Blank clears the field'],
